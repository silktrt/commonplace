...
import { TODAY } from "./liturgical.js";
    ...
    <div>
      ...
      <div className="section">
        ...
        <div className="card">
          ...
          <p className="poem-author">{d.poem.author} · <em>{d.poem.collection}</em></p>
          {d.poem.note && <p className="source-line" style={{ marginTop: "0.5rem" }}>{d.poem.note}</p>}
        </div>
      </div>
